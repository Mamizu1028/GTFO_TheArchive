...
#warning TODO: Not this
        ...
        {
            string dir = Path.Combine(Path.GetDirectoryName(feature.ModuleGroup == ArchiveMod.ARCHIVE_CORE_FEATURE_GROUP ? ArchiveMod.CORE_PATH : feature.FeatureInternal.OriginAssembly.Location), "Localization");
